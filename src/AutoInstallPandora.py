...
class PandoraInstallerWidget(QWidget):
    def __init__(self):
        ...
        self.handler_not_working_hint = QLabel("if pandora handler shows NOT CONNECTED on the lower left corner\n1. open Pandora Settings, \n2. Go to Pandora Coordinator \n3. Check on Enable Pandora Coordinator\n4. Do that only on one of the machines")
        # layout
        ...
        self.layout.addWidget(self.handler_not_working_hint)
        # deault values:
